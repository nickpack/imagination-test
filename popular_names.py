    ...
    def handle_data(self, data):
        if self.in_td:
            if data.isdigit():
                ...
                # that aren't part of the data set, though this is likely brittle if they change something!
...
def parse_body(body, name, end_year=2014):
    ...
    # Index the data into a sensible format we can iterate and ignore as appropriate
    ...
    if not yearly_counts:
        # Although subjectively no data is an error, in this instance the script executed successfully but returned null
